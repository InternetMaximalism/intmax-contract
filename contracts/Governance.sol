...
contract Governance is AccessControl, Config {
    ...
    /// @notice Total number of ERC20 tokens registered in the network (excluding ETH,
    /// which is hardcoded as tokenId = 0)
    ...
    function addToken(address _token) external onlyRole(GOVERNANCE_ROLE) {
        ...
        require(
            totalTokens < MAX_AMOUNT_OF_REGISTERED_TOKENS,
            "totalTokens has already reach the max amount"
